...
function Login({}: Props) {
  ...
  const [confirmPassword, setConfirmPassword] =
    useState<Inputs["confirmPassword"]>();
  ...
  return (
    <div className="w-[432px] ">
      <div className="mb-[55px]">
        <h2 className="text-[36px] text-secondary font-[800] mb-[11px] font-Manrope">
          Login
        </h2>
        <p className="text-[13.33px] text-defaultgray italic">
          This only applies to students of Masinde Muliro University of Science
          and Techology
        </p>
      </div>
      ...
      <form action="" className="flex flex-col gap-[36px]">
        <span
          className={`border-b border-defaultgray outline-none ${
            input ? checker.valid : checker.invalid
          }`}
        >
          <input
            type="password"
            className={` outline-none   text-secondary text-[19.2px] w-full `}
            placeholder="RF Number/ Reg Number"
            onChange={refReg}
          />{" "}
        </span>
        <span className="border-b border-defaultgray outline-none ">
          <input
            type="password"
            className="border-none outline-none   text-secondary text-[19.2px] "
        ...
        <input
          ...
          className="py-[10px] cursor-pointer bg-secondary text-white"
        />
      </form>
